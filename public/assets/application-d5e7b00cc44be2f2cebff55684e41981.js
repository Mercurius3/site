...
(function() {
  $(function() {
    ...
    $(".change a").click(function(event) {
      event.preventDefault();
      $(this).closest(".change").children(".change_form").toggle("slow");
      return $(this).closest(".change").children(".change_info").toggle();
    });
    $("#confirm_changes").hide();
    return $("#confirm_changes_button").click(function(event) {
      event.preventDefault();
      $("#confirm_changes").toggle("slow");
      return $("#confirm_changes_button").toggle();
    });
  });
