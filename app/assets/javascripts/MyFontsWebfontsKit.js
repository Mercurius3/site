/*
 ...
 MyFonts Webfont Build ID 3003416, 2015-04-04T11:30:00-0400
 ...
 Webfont: Lucida-Bol by URW++
 URL: http://www.myfonts.com/fonts/urw/lucida-t/bold/
 Copyright: Copyright 2010 URW++ Design &amp; Development Hamburg
 Licensed pageviews: 10,000


 License: http://www.myfonts.com/viewlicense?type=web&buildid=3003416

 ? 2015 MyFonts Inc
*/
var customPath = "/assets/fonts/";
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2dd418";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0,woff2Enabled=1;
...
for(var fonts=[{fontFamily:"Lucida-Bol",url:wfpath+"2DD418_0"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+fonts[i].fontWeight+";");fonts[i].fontStyle&&(css+="font-style: "+fonts[i].fontStyle+";");css+=
