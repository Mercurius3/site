...
var count=document.createElement('script');count.type='text/javascript';count.async=true;count.src='//hello.myfonts.net/count/28e695';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if(typeof(woffEnabled)=='undefined'){var woffEnabled=true;}
...
suffix="_unhinted";var fonts=[{"fontFamily":"Lucida-Bol","url":wfpath+"28E695_0"+suffix+"_0."+webfontType}];var len=fonts.length;if(webfontType=="ttf"){var data_fn=suffix=="_unhinted"?"28E695_data_unhintedttf.css":"28E695_datattf.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
else if(webfontType=="woff"){var data_fn=suffix=="_unhinted"?"28E695_data_unhintedwoff.css":"28E695_datawoff.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
